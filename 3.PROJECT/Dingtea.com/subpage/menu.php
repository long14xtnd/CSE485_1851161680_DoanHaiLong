                            ...
                            <nav class="navbar  navbar-light navbar-expand-xl py-1 ">
                                ...
                                <div class="collapse navbar-collapse" id="main-nav">
                                    ...
                                    <ul class="navbar-nav mr-auto main-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="findstore.php" class="nav-link text-uppercase">Tìm cửa hàng</a>
                                        </li>
                                        <li class="nav-item dropdown">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <h3 class="title-1 text-center text-uppercase">Thực đơn</h3>
                        <img src="../images/menu_short_final.jpg" class="mb-4" alt="" style="width:100% ; height:auto">
                    </div>
                </div>
            </div>
        </div>
